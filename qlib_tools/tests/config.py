...
MULTI_TRANSFORMER_MODEL = {
    ...
    "module_path": "qlib_tools.contrib.model.pytorch_informer_ts",
    # "module_path": "qlib_tools.contrib.model.pytorch_transformer_ts",
    "kwargs":{
        "seed": 0,
        "n_jobs": 8,
        "batch_size": 16,
...
def get_multi_transformer(dataset_kwargs={}, handler_kwargs={"instruments": CSI300_MARKET}):
    return {
        "model": MULTI_TRANSFORMER_MODEL,
        "dataset": get_tf_dataset_config(**dataset_kwargs, handler_kwargs=handler_kwargs),
...
CSI300_MULTI_TRANSFORMER_TASK = get_multi_transformer(handler_kwargs={"instruments": CSI300_MARKET})
